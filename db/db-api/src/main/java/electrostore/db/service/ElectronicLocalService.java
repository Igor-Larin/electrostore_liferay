...
public interface ElectronicLocalService
	...
	public Electronic createElectronic(long electronic_id);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Electronic deleteElectronic(long electronic_id)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Electronic fetchElectronic(long electronic_id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Electronic getElectronic(long electronic_id) throws PortalException;
