 ...
 * <code>electrostore.db.service.impl.ElectronicLocalServiceImpl</code> and
...
public class ElectronicLocalServiceUtil {
	 ...
	 */
	public static Electronic createElectronic(long electronic_id) {
		return getService().createElectronic(electronic_id);
	}
	 ...
	 */
	public static Electronic deleteElectronic(long electronic_id)
		throws PortalException {

		return getService().deleteElectronic(electronic_id);
	}
	...
	public static Electronic fetchElectronic(long electronic_id) {
		return getService().fetchElectronic(electronic_id);
	}
	 ...
	 * @throws PortalException if a electronic with the primary key could not be found
	 */
	public static Electronic getElectronic(long electronic_id)
		throws PortalException {

		return getService().getElectronic(electronic_id);
	}
