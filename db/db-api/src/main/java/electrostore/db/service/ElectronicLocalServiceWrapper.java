...
public class ElectronicLocalServiceWrapper
	 ...
	 */
	@Override
	public electrostore.db.model.Electronic addElectronic(
		electrostore.db.model.Electronic electronic) {
	 ...
	 */
	@Override
	public electrostore.db.model.Electronic createElectronic(
		long electronic_id) {

		return _electronicLocalService.createElectronic(electronic_id);
	}
	 ...
	 */
	@Override
	public electrostore.db.model.Electronic deleteElectronic(
		electrostore.db.model.Electronic electronic) {
	 ...
	 */
	@Override
	public electrostore.db.model.Electronic deleteElectronic(long electronic_id)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _electronicLocalService.deleteElectronic(electronic_id);
	}
	...
	@Override
	public electrostore.db.model.Electronic fetchElectronic(
		long electronic_id) {

		return _electronicLocalService.fetchElectronic(electronic_id);
	}
	 ...
	 */
	@Override
	public electrostore.db.model.Electronic getElectronic(long electronic_id)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _electronicLocalService.getElectronic(electronic_id);
	}
	 ...
	 */
	@Override
	public java.util.List<electrostore.db.model.Electronic> getElectronics(
		int start, int end) {
	 ...
	 */
	@Override
	public electrostore.db.model.Electronic updateElectronic(
		electrostore.db.model.Electronic electronic) {
