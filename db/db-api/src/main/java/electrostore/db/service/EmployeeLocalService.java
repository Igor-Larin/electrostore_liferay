...
public interface EmployeeLocalService
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Employee deleteEmployee(long employee_id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Employee fetchEmployee(long employee_id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Employee getEmployee(long employee_id) throws PortalException;
