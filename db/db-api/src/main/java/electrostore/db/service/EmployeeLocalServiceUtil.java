 ...
 * <code>electrostore.db.service.impl.EmployeeLocalServiceImpl</code> and
...
public class EmployeeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>electrostore.db.service.impl.EmployeeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static void addEmployee(javax.portlet.ActionRequest request) {
		getService().addEmployee(request);
	}
	 ...
	 */
	public static Employee createEmployee(long employee_id) {
	 ...
	 */
	public static Employee deleteEmployee(long employee_id)
		throws PortalException {
	...
	public static Employee fetchEmployee(long employee_id) {
	 ...
	 * @throws PortalException if a employee with the primary key could not be found
	 */
	public static Employee getEmployee(long employee_id)
		throws PortalException {
