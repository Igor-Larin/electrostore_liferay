...
public class EmployeeLocalServiceWrapper
	...
	@Override
	public void addEmployee(javax.portlet.ActionRequest request) {
		_employeeLocalService.addEmployee(request);
	}
	 ...
	 */
	@Override
	public electrostore.db.model.Employee addEmployee(
		electrostore.db.model.Employee employee) {
	 ...
	 */
	@Override
	public electrostore.db.model.Employee createEmployee(long employee_id) {
	 ...
	 */
	@Override
	public electrostore.db.model.Employee deleteEmployee(
		electrostore.db.model.Employee employee) {
	 ...
	 */
	@Override
	public electrostore.db.model.Employee deleteEmployee(long employee_id)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public electrostore.db.model.Employee fetchEmployee(long employee_id) {
	 ...
	 */
	@Override
	public electrostore.db.model.Employee getEmployee(long employee_id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<electrostore.db.model.Employee> getEmployees(
		int start, int end) {
	 ...
	 */
	@Override
	public electrostore.db.model.Employee updateEmployee(
		electrostore.db.model.Employee employee) {
