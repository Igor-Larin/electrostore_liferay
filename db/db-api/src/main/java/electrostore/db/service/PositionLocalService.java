...
public interface PositionLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>electrostore.db.service.impl.PositionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the position local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PositionLocalServiceUtil} if injection and service tracking are not available.
	 */
