 ...
 * <code>electrostore.db.service.impl.PositionLocalServiceImpl</code> and
...
public class PositionLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>electrostore.db.service.impl.PositionLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Position createPosition(long position_id) {
	 ...
	 */
	public static Position deletePosition(long position_id)
		throws PortalException {
	 ...
	 * @return the position that was removed
	 */
	public static Position deletePosition(Position position) {
	...
	public static Position fetchPosition(long position_id) {
	 ...
	 * @throws PortalException if a position with the primary key could not be found
	 */
	public static Position getPosition(long position_id)
		throws PortalException {
	 ...
	 */
	public static List<Position> getPositions(int start, int end) {
	 ...
	 */
	public static Position updatePosition(Position position) {
	...
	private static volatile PositionLocalService _service;
