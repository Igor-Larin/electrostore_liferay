...
public class PositionLocalServiceWrapper
	 ...
	 */
	@Override
	public electrostore.db.model.Position addPosition(
		electrostore.db.model.Position position) {
	 ...
	 */
	@Override
	public electrostore.db.model.Position createPosition(long position_id) {
	 ...
	 */
	@Override
	public electrostore.db.model.Position deletePosition(long position_id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public electrostore.db.model.Position deletePosition(
		electrostore.db.model.Position position) {
	...
	@Override
	public electrostore.db.model.Position fetchPosition(long position_id) {
	 ...
	 */
	@Override
	public electrostore.db.model.Position getPosition(long position_id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<electrostore.db.model.Position> getPositions(
		int start, int end) {
	 ...
	 */
	@Override
	public electrostore.db.model.Position updatePosition(
		electrostore.db.model.Position position) {
