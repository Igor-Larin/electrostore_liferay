...
public interface PurchaseLocalService
	...
	public Purchase deletePurchase(long purchase_id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Purchase fetchPurchase(long purchase_id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Purchase getPurchase(long purchase_id) throws PortalException;
