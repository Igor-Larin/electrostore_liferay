 ...
 * <code>electrostore.db.service.impl.PurchaseLocalServiceImpl</code> and
...
public class PurchaseLocalServiceUtil {
	...
	public static void addPurchaseFromZip(
		String purchaseString, String delimeter) {

		getService().addPurchaseFromZip(purchaseString, delimeter);
	}
	 ...
	 */
	public static Purchase createPurchase(long purchase_id) {
	 ...
	 */
	public static Purchase deletePurchase(long purchase_id)
		throws PortalException {
	...
	public static Purchase fetchPurchase(long purchase_id) {
	 ...
	 * @throws PortalException if a purchase with the primary key could not be found
	 */
	public static Purchase getPurchase(long purchase_id)
		throws PortalException {
