...
public interface PurchaseTypeLocalService
	...
	public PurchaseType createPurchaseType(long purchasetype_id);
	...
	public PurchaseType deletePurchaseType(long purchasetype_id)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PurchaseType fetchPurchaseType(long purchasetype_id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PurchaseType getPurchaseType(long purchasetype_id)
		throws PortalException;
