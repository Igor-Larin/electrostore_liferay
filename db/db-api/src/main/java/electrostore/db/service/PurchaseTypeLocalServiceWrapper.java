...
public class PurchaseTypeLocalServiceWrapper
	 ...
	 */
	@Override
	public electrostore.db.model.PurchaseType addPurchaseType(
		electrostore.db.model.PurchaseType purchaseType) {
	 ...
	 */
	@Override
	public electrostore.db.model.PurchaseType createPurchaseType(
		long purchasetype_id) {

		return _purchaseTypeLocalService.createPurchaseType(purchasetype_id);
	}
	 ...
	 */
	@Override
	public electrostore.db.model.PurchaseType deletePurchaseType(
			long purchasetype_id)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _purchaseTypeLocalService.deletePurchaseType(purchasetype_id);
	}
	...
	@Override
	public electrostore.db.model.PurchaseType fetchPurchaseType(
		long purchasetype_id) {

		return _purchaseTypeLocalService.fetchPurchaseType(purchasetype_id);
	}
	 ...
	 */
	@Override
	public electrostore.db.model.PurchaseType getPurchaseType(
			long purchasetype_id)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _purchaseTypeLocalService.getPurchaseType(purchasetype_id);
	}
	 ...
	 */
	@Override
	public java.util.List<electrostore.db.model.PurchaseType> getPurchaseTypes(
		int start, int end) {
	 ...
	 */
	@Override
	public electrostore.db.model.PurchaseType updatePurchaseType(
		electrostore.db.model.PurchaseType purchaseType) {
