...
import electrostore.db.model.PurchaseTypeModel;
...
/**
 * The base model implementation for the PurchaseType service. Represents a row in the &quot;purchasetype&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class PurchaseTypeModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "purchasetype";

	public static final Object[][] TABLE_COLUMNS = {
		{"purchasetype_id", Types.BIGINT}, {"name", Types.VARCHAR}
	};
	...
	public static final String TABLE_SQL_CREATE =
		"create table purchasetype (purchasetype_id LONG not null primary key,name VARCHAR(100) null)";

	public static final String TABLE_SQL_DROP = "drop table purchasetype";

	public static final String ORDER_BY_JPQL =
		" ORDER BY purchaseType.purchasetype_id ASC";
	 ...
	 */
	@Deprecated
	public static final long PURCHASETYPE_ID_COLUMN_BITMASK = 1L;
	...
	static {
		...
		attributeGetterFunctions.put(
			"purchasetype_id", PurchaseType::getPurchasetype_id);
		attributeSetterBiConsumers.put(
			"purchasetype_id",
			(BiConsumer<PurchaseType, Long>)PurchaseType::setPurchasetype_id);
	...
	public Object clone() {
		...
		purchaseTypeImpl.setPurchasetype_id(getPurchasetype_id());
	...
	public CacheModel<PurchaseType> toCacheModel() {
		...
		purchaseTypeCacheModel.purchasetype_id = getPurchasetype_id();
	...
	static {
		...
		columnBitmasks.put("purchasetype_id", 1L);
