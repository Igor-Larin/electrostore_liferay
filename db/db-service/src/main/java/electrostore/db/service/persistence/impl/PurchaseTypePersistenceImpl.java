...
import electrostore.db.model.impl.PurchaseTypeImpl;
import electrostore.db.model.impl.PurchaseTypeModelImpl;
...
public class PurchaseTypePersistenceImpl
	 ...
	 */
	@Override
	public PurchaseType create(long purchasetype_id) {
		PurchaseType purchaseType = new PurchaseTypeImpl();

		purchaseType.setNew(true);
		purchaseType.setPrimaryKey(purchasetype_id);
	 ...
	 */
	@Override
	public PurchaseType remove(long purchasetype_id)
		throws NoSuchPurchaseTypeException {

		return remove((Serializable)purchasetype_id);
	}
	 ...
	 */
	@Override
	public PurchaseType findByPrimaryKey(long purchasetype_id)
		throws NoSuchPurchaseTypeException {

		return findByPrimaryKey((Serializable)purchasetype_id);
	}
	 ...
	 */
	@Override
	public PurchaseType fetchByPrimaryKey(long purchasetype_id) {
		return fetchByPrimaryKey((Serializable)purchasetype_id);
	}
