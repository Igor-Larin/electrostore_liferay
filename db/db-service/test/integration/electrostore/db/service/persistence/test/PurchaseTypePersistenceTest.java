...
import electrostore.db.exception.NoSuchPurchaseTypeException;
import electrostore.db.model.PurchaseType;
import electrostore.db.service.PurchaseTypeLocalServiceUtil;
import electrostore.db.service.persistence.PurchaseTypePersistence;
import electrostore.db.service.persistence.PurchaseTypeUtil;
...
public class PurchaseTypePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		Assert.assertEquals(
			existingPurchaseType.getPurchasetype_id(),
			newPurchaseType.getPurchasetype_id());
		Assert.assertEquals(
	...
	protected OrderByComparator<PurchaseType> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"purchasetype", "purchasetype_id", true, "name", true);
	}
	...
	public void testDynamicQueryByPrimaryKeyExisting() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq(
				"purchasetype_id", newPurchaseType.getPurchasetype_id()));
	...
	public void testDynamicQueryByPrimaryKeyMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq(
				"purchasetype_id", RandomTestUtil.nextLong()));
	...
	public void testDynamicQueryByProjectionExisting() throws Exception {
		...
		dynamicQuery.setProjection(
			ProjectionFactoryUtil.property("purchasetype_id"));

		Object newPurchasetype_id = newPurchaseType.getPurchasetype_id();

		dynamicQuery.add(
			RestrictionsFactoryUtil.in(
				"purchasetype_id", new Object[] {newPurchasetype_id}));

		List<Object> result = _persistence.findWithDynamicQuery(dynamicQuery);

		Assert.assertEquals(1, result.size());

		Object existingPurchasetype_id = result.get(0);

		Assert.assertEquals(existingPurchasetype_id, newPurchasetype_id);
	}
	...
	public void testDynamicQueryByProjectionMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.in(
				"purchasetype_id", new Object[] {RandomTestUtil.nextLong()}));
